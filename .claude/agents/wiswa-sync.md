...
When a managed file is modified directly (e.g. manual edits to generated config files, etc.),
you update `.wiswa.jsonnet` so that running Wiswa again would produce the same result.
