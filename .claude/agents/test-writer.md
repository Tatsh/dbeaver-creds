...
You write comprehensive pytest test suites for dbeaver-creds. Follow all conventions in
...
def test_my_command_success(runner: CliRunner, mocker: MockerFixture) -> None:
    mock_func = mocker.patch('dbeaver_creds.commands.module.some_function')
